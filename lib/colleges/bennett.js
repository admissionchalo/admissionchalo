const bennett = {
  ...
  news: [
    "Bennett University admissions 2026-27 are open for B.Tech, MBA, BCA, BBA and other programs.",
    "Bennett University ranked among Top 100 Universities Globally in Times Higher Education (THE) Interdisciplinary Science Rankings 2026.",
    "Bennett University School of Management ranked #65 in NIRF Rankings 2025.",
    "Bennett University's curriculum for School of Computer Science developed in partnership with Georgia Institute of Technology, USA.",
    "Bennett Hatchery — the university's startup incubator — provides mentorship, seed funding and resources to student entrepreneurs.",
  ],

  stories: [
    { title: "Highest international package of Rs.1.2 Crore in 2025 B.Tech placements", emoji: "🚀" },
    { title: "Academic partnership with Georgia Institute of Technology, USA for CS curriculum", emoji: "🌍" },
    { title: "NAAC A+ accreditation — ranked 25th among top private new-age universities", emoji: "⭐" },
    { title: "68-acre state-of-the-art campus with supercomputing facility", emoji: "💻" },
  ],

  about: "Bennett University, Greater Noida, is a premier private university established in 2016 by The Times Group — India's largest media conglomerate. Accredited with NAAC A+ and recognized by UGC, BCI, and AIU, Bennett University offers world-class education across Engineering, Management, Law, Media, Design, and more. The university benefits from unparalleled industry connections through The Times Group network.",
  ...
  cutoffs: [
    { course: "B.Tech Computer Science & Engineering", gen: "90+ percentile (JEE Main)" },
    { course: "B.Tech Artificial Intelligence & ML", gen: "85+ percentile (JEE Main)" },
    { course: "B.Tech Electronics & Communication", gen: "75+ percentile (JEE Main)" },
    { course: "B.Tech Mechanical Engineering", gen: "70+ percentile (JEE Main)" },
    { course: "MBA", gen: "60+ percentile (CAT/MAT)" },
  ],

  admissions: [
    { prog: "B.Tech", eligibility: "10+2 with 55% in PCM", exam: "JEE Main / SAT / CUET", counselling: "Direct / BU Portal", seats: "-" },
    { prog: "MBA", eligibility: "Graduation with 50%", exam: "CAT / MAT / CMAT / GMAT / BU-MAT", counselling: "Direct + PI", seats: "-" },
    { prog: "BCA / BBA", eligibility: "10+2 with 50%", exam: "CUET / Merit", counselling: "Direct", seats: "-" },
    { prog: "BBA LLB", eligibility: "10+2 with 60%", exam: "CLAT / Merit", counselling: "Direct", seats: 60 },
    { prog: "M.Tech", eligibility: "B.Tech/BE with 60%", exam: "GATE", counselling: "Direct", seats: "-" },
  ],

  admissionDates: [
    ["B.Tech Application (2026)", "Open Now — bennett.edu.in"],
    ["MAT 2026 (May PBT) Last Date", "May 25, 2026"],
    ["CUET UG 2026 Exam", "May 11 - 31, 2026"],
    ["JEE Main 2026 Session 2 Result", "April 20, 2026"],
    ["MBA Admissions (BU-MAT)", "Rolling basis — Apply anytime"],
  ],

  placements: {
    highest: "Rs.1.2 Crore (International)",
    average: "Rs.12.5 LPA (B.Tech CSE)",
    medianUG: "Rs.7.5 LPA",
    percentage: "~90%",
    companies: "322+",
    totalOffers: "1000+",
    ugPlaced: "-",
    topRecruiters: ["Google", "Microsoft", "Goldman Sachs", "Amazon", "Adobe", "S&P Global", "PwC", "TCS", "Wipro", "Capgemini", "Accenture", "EY", "HCL", "Aditya Birla", "Berger Paints"],
    btechWise: [
  ...
  reviews: {
    ...
    total: 346,
    breakdown: [
      { label: "College Infrastructure", val: 4.5 },
      { label: "Academics", val: 4.2 },
      { label: "Placements", val: 4.3 },
      { label: "Value for Money", val: 3.8 },
      { label: "Campus Life", val: 4.4 },
    ],
    list: [
